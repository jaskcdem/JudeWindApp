    ...
    public class EquipRepository : ISampleRepository
    {
        ...
        readonly List<(Weapon wep, string defName, (CharParameter para, int basePoint, int growPoint)[] values)> WepList
           = [(Weapon.Sword, "N-衛兵之劍", [(CharParameter.Atk, 4, 1), (CharParameter.Def, 1, 1)])
                ...
                ,(Weapon.Sword, "LR-歐開尼德斯", [(CharParameter.Atk, 13, 2), (CharParameter.Agi, 11, 4)])
                ...
                ,(Weapon.Katana, "ER-白梅刀", [(CharParameter.Mhp, 16, 8), (CharParameter.Mmp, 8, 8), (CharParameter.Atk, 9, 4)])
                ,(Weapon.Katana, "ER-綠風刀", [(CharParameter.Mhp, 16, 8), (CharParameter.Mmp, 8, 8), (CharParameter.Atk, 9, 4)])
                ,(Weapon.Katana, "LR-妖刀村正", [(CharParameter.Atk, 14, 3), (CharParameter.Mat, 14, 3)])
                ,(Weapon.Rapier, "N-閃爍之光", [(CharParameter.Atk, 3, 1), (CharParameter.Agi, 2, 1)])
                ,(Weapon.Rapier, "R-優白光暉", [(CharParameter.Atk, 5, 1), (CharParameter.Agi, 4, 1)])
                ,(Weapon.Rapier, "R-炫目爍光", [(CharParameter.Atk, 5, 1), (CharParameter.Mdf, 4, 1)])
                ,(Weapon.Rapier, "SR-火之恩典", [(CharParameter.Atk, 7, 1), (CharParameter.Mat, 6, 1)])
                ,(Weapon.Rapier, "SR-風之恩典", [(CharParameter.Atk, 7, 1), (CharParameter.Def, 6, 1)])
                ,(Weapon.Rapier, "ER-電光細劍", [(CharParameter.Atk, 9, 2)])
                ,(Weapon.Rapier, "LR-雙創細劍", [(CharParameter.Atk, 11, 3)])
                ...
                ,(Weapon.Dagger, "R-音速彎鉤", [(CharParameter.Atk, 3, 2), (CharParameter.Agi, 2, 2)])
                ,(Weapon.Dagger, "SR-暴風雪開膛手", [(CharParameter.Atk, 6, 2), (CharParameter.Mat, 1, 1), (CharParameter.Agi, 2, 2)])
                ,(Weapon.Dagger, "ER-赫斯提亞之爪", [(CharParameter.Atk, 9, 2), (CharParameter.Mat, 2, 1), (CharParameter.Agi, 5, 2)])
                ,(Weapon.Dagger, "LR-艾特坦古", [(CharParameter.Atk, 15, 2), (CharParameter.Mat, 3, 1)])
                ,(Weapon.GreatSword, "N-戰士鬥劍", [(CharParameter.Atk, 3, 1), (CharParameter.Mat, 2, 1)])
                ,(Weapon.GreatSword, "R-深綠制裁者", [(CharParameter.Atk, 5, 1), (CharParameter.Def, 7, 4)])
                ,(Weapon.GreatSword, "SR-黃金劍", [(CharParameter.Atk, 5, 1), (CharParameter.Mat, 4, 1)])
                ,(Weapon.GreatSword, "ER-赤紅重壓", [(CharParameter.Atk, 9, 4)])
                ,(Weapon.GreatSword, "LR-光閃劍", [(CharParameter.Atk, 13, 2), (CharParameter.Agi, 11, 4)])
                ...
                //,(Weapon.Naginata, "ER-", [])
                //,(Weapon.Naginata, "LR-", [])
                ,(Weapon.Dual_wield, "N-闡釋者&逐闇者", [(CharParameter.Atk, 5, 1)])
                ,(Weapon.Dual_wield, "R-閃電分割者 雙重", [(CharParameter.Atk, 9, 2), (CharParameter.Mat, 7, 4)])
                ,(Weapon.Dual_wield, "R-渾沌突襲者 雙重", [(CharParameter.Atk, 9, 2), (CharParameter.Mdf, 7, 4)])
                ,(Weapon.Dual_wield, "SR-村正G4 雙重", [(CharParameter.Atk, 17, 5)])
                ,(Weapon.Dual_wield, "ER-英勇希望 雙重", [(CharParameter.Atk, 17, 5), (CharParameter.Def, 7, 4), (CharParameter.Mdf, 7, 4)])
                ,(Weapon.Dual_wield, "LR-闡釋者 冰柱&逐輝者", [(CharParameter.Atk, 22, 5), (CharParameter.Mat, 10, 2)])
                ,(Weapon.Dual_wield, "LR-闡釋者 赤紅&逐火者", [(CharParameter.Atk, 22, 5), (CharParameter.Mat, 10, 2)])
                ...
                ,(Weapon.Axe, "ER-暴虐墜落", [(CharParameter.Atk, 11, 3)])
                ,(Weapon.Axe, "LR-大地之鑒", [(CharParameter.Atk, 16, 3)])
                ,(Weapon.Hammer, "N-鬥士戰錘", [(CharParameter.Atk, 5, 1)])
                ,(Weapon.Hammer, "R-破壞者之錘", [(CharParameter.Atk, 7, 1)])
                ,(Weapon.Hammer, "SR-冰霜衝擊", [(CharParameter.Atk, 8, 2)])
                ,(Weapon.Hammer, "SR-熾烈火炬", [(CharParameter.Atk, 8, 2)])
                ,(Weapon.Hammer, "ER-波瑞阿斯猛擊", [(CharParameter.Atk, 13, 3)])
                ,(Weapon.Hammer, "LR-龍爪棍", [(CharParameter.Atk, 15, 4)])
                ,(Weapon.Stick, "N-驅逐者", [(CharParameter.Atk, 5, 1)])
                ,(Weapon.Stick, "R-強勢強打者", [(CharParameter.Atk, 6, 1), (CharParameter.Mat, 1, 1)])
                ,(Weapon.Stick, "SR-美麗指揮棒", [(CharParameter.Mat, 9, 1)])
                ,(Weapon.Stick, "ER-浮島之峽", [(CharParameter.Atk, 11, 3)])
                ,(Weapon.Stick, "LR-好戰巨人", [(CharParameter.Atk, 16, 3)])
                ,(Weapon.Mace, "N-神官錘矛", [(CharParameter.Atk, 1, 1), (CharParameter.Mat, 4, 1)])
                ,(Weapon.Mace, "R-燃燒鎚矛", [(CharParameter.Atk, 7, 1), (CharParameter.Mat, 6, 1)])
                ,(Weapon.Mace, "SR-葛利達之星", [(CharParameter.Atk, 15, 2), (CharParameter.Def, 6, 4)])
                ,(Weapon.Mace, "ER-晨曉之星", [(CharParameter.Atk, 20, 4)])
                ,(Weapon.Mace, "LR-龍之焰", [(CharParameter.Atk, 24, 3), (CharParameter.Mat, 16, 4)])
                ,(Weapon.Halberd, "N-白閃十字槍", [(CharParameter.Atk, 5, 1), (CharParameter.Def, 1, 1), (CharParameter.Mat, 2, 1)])
                ,(Weapon.Halberd, "R-黃金樹大槍", [(CharParameter.Mmp, 12, 6), (CharParameter.Atk, 5, 1)])
                ,(Weapon.Halberd, "SR-紅櫻槍", [(CharParameter.Mmp, 18, 6), (CharParameter.Atk, 9, 2)])
                ,(Weapon.Halberd, "ER-天狼槍", [(CharParameter.Mhp, 24, 8), (CharParameter.Atk, 14, 2)])
                ,(Weapon.Halberd, "LR-獅鷹之喙", [(CharParameter.Atk, 20, 3), (CharParameter.Def, 12, 6), (CharParameter.Mdf, 9, 9)])
                ...
                ,(Weapon.Spear, "R-四風藩籬", [(CharParameter.Atk, 9, 2), (CharParameter.Def, 3, 1)])
                ,(Weapon.Spear, "SR-靈魂之槍", [(CharParameter.Atk, 11, 2), (CharParameter.Agi, 6, 1)])
                ,(Weapon.Spear, "ER-水靈之槍", [(CharParameter.Atk, 15, 3), (CharParameter.Mdf, 2, 1)])
                ,(Weapon.Spear, "ER-火迸之槍", [(CharParameter.Atk, 15, 3), (CharParameter.Mat, 2, 1)])
                ,(Weapon.Spear, "LR-龍王之牙", [(CharParameter.Atk, 20, 3), (CharParameter.Mdf, 5, 2), (CharParameter.Agi, 1, 1)])
                ...
                ,(Weapon.Bow, "ER-赤桐弓", [(CharParameter.Atk, 12, 3)])
                ,(Weapon.Bow, "LR-龍嚎戰弩", [(CharParameter.Atk, 20, 5), (CharParameter.Agi, 6, 6)])
                //,(Weapon.Crossbow, "N-", [])
                //,(Weapon.Crossbow, "R-", [])
                //,(Weapon.Crossbow, "SR-", [])
                //,(Weapon.Crossbow, "ER-", [])
                //,(Weapon.Crossbow, "LR-", [])
                ,(Weapon.Gun, "N-SPB鉀", [(CharParameter.Atk, 6, 3), (CharParameter.Agi, 1, 2)])
                ,(Weapon.Gun, "R-北落師門", [(CharParameter.Atk, 10, 3), (CharParameter.Agi, 3, 2)])
                ,(Weapon.Gun, "SR-天狼星", [(CharParameter.Atk, 14, 3), (CharParameter.Agi, 5, 2)])
                ,(Weapon.Gun, "ER-飆風", [(CharParameter.Atk, 18, 3), (CharParameter.Agi, 7, 2)])
                ,(Weapon.Gun, "LR-神聖箭", [(CharParameter.Atk, 22, 3), (CharParameter.Agi, 9, 2)])
                ...
                ,(Weapon.Staff, "SR-精靈長杖", [(CharParameter.Atk, 4, 1), (CharParameter.Mat, 9, 3)])
                ,(Weapon.Staff, "ER-星壇權杖", [(CharParameter.Mmp, 18, 6), (CharParameter.Atk, 6, 1), (CharParameter.Mat, 15, 3)])
                ,(Weapon.Staff, "LR-夜蘭香花杖", [(CharParameter.Atk, 10, 2), (CharParameter.Mat, 21, 3)])
                //,(Weapon.Knuckles, "N-", [])
                //,(Weapon.Knuckles, "R-", [])
                //,(Weapon.Knuckles, "SR-", [])
                //,(Weapon.Knuckles, "ER-", [])
                ...
                ,(Weapon.Claw, "SR-貓之野性", [(CharParameter.Atk, 8, 1)])
                //,(Weapon.Claw, "ER-", [])
                //,(Weapon.Claw, "LR-", [])
                ,(Weapon.Scythe, "N-飛燕大鐮", [(CharParameter.Atk, 2, 1)])
                ,(Weapon.Scythe, "R-夜鶯大鐮", [(CharParameter.Atk, 3, 1), (CharParameter.Mat, 2, 1)])
                ,(Weapon.Scythe, "SR-死神鐮刀", [(CharParameter.Atk, 5, 1), (CharParameter.Mat, 2, 1), (CharParameter.Agi, 2, 1)])
                ,(Weapon.Scythe, "ER-鋼鐵大鐮", [(CharParameter.Atk, 9, 2), (CharParameter.Def, 3, 1), (CharParameter.Mat, 2, 1)])
                ,(Weapon.Scythe, "LR-邪龍粗吼", [(CharParameter.Atk, 14, 3)])
                //,(Weapon.Whip, "N-", [])
                //,(Weapon.Whip, "R-", [])
                //,(Weapon.Whip, "SR-", [])
        ...
        readonly List<(Armor arm, string defName, (CharParameter para, int basePoint, int growPoint)[] values)> ArmList
            = [(Armor.Clothes, "N-步兵服", [(CharParameter.Def, 2, 1), (CharParameter.Mat, 1, 1), (CharParameter.Mdf, 2, 1)])
                ...
                ,(Armor.Robes, "LR-賢者連身裙", [(CharParameter.Mhp, 56, 8), (CharParameter.Mmp, 42, 6), (CharParameter.Def, 0, 7), (CharParameter.Mdf, 0, 7)])
                ...
                ,(Armor.LightArmor, "SR-龍鱗胸甲", [(CharParameter.Def, 7, 7), (CharParameter.Mdf, 7, 7)])
                ,(Armor.LightArmor, "ER-武士甲冑", [(CharParameter.Mhp, 16, 8), (CharParameter.Atk, 3, 1), (CharParameter.Def, 3, 1), (CharParameter.Mdf, 3, 1)])
                ,(Armor.LightArmor, "LR-緋紅胸甲", [(CharParameter.Def, 21, 7), (CharParameter.Mdf, 21, 7)])
                ...
                ,(Armor.HeavyArmor, "LR-冰晶之鎧", [(CharParameter.Def, 28, 7), (CharParameter.Mdf, 28, 7), (CharParameter.Agi, -1, -3)])
                ...
                ,(Armor.SmallSheld, "LR-魔光圓盾", [(CharParameter.Mhp, 32, 8), (CharParameter.Def, 9, 1), (CharParameter.Mdf, 9, 1)])
                ...
                ,(Armor.BigSheld, "ER-龍鱗大盾", [(CharParameter.Def, 12, 4), (CharParameter.Mdf, 12, 4), (CharParameter.Agi, -1, -2)])
                ,(Armor.BigSheld, "LR-擎天之盾", [(CharParameter.Def, 20, 4), (CharParameter.Mdf, 20, 4), (CharParameter.Agi, -1, -3)])
                ...
                ,(Armor.Hat, "N-盜賊帽子", [(CharParameter.Def, 1, 1), (CharParameter.Mat, 3, 1), (CharParameter.Mdf, 1, 1)])
                ...
                ,(Armor.Helmet, "LR-神羽盔", [(CharParameter.Def, 10, 2), (CharParameter.Mdf, 8, 2)])
                ...
                ,(Armor.Shoes, "N-盜賊靴子", [(CharParameter.Def, 2, 1), (CharParameter.Mdf, 2, 1), (CharParameter.Agi, 1, 1)])
